...
Map<Character, Integer> hm  = new HashMap<Character, Integer>(); 
    ...
    public Task(String filename, Map<Character, Integer> map) {
       hm = map;
       nombre = filename;
    }
...
public class main {
    ...
    public static void main(String[] args) {
        ...
        try {
         ...
         // creates five tasks
         Runnable r1 = new Task("archivo0.txt",hm);
         Runnable r2 = new Task("archivo1.txt",hm);
         Runnable r3 = new Task("archivo2.txt",hm);     
         Runnable r4 = new Task("archivo3.txt",hm);
         Runnable r5 = new Task("archivo4.txt",hm);
